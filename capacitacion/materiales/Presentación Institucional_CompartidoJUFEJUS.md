...
[papel_lapiz](https://drive.google.com/file/d/1QW4DYy3HSp3q-Sco5XmwNmv0_Zqp5vrL/view?usp=sharing)


```r
library(knitr)
knitr::include_graphics('papel_lapiz.jpg')
```

![plot of chunk unnamed-chunk-1](papel_lapiz.jpg)
...
+ U$S 500 mil: Software Integrado (código cerrado)
+ U$S 109 mil: Tableros (código cerrado)


APGE - Camino Difícil
========================================================

+ U$S 200 mil: Presentaciones-Tableros-Boletín (código abierto)
+ $ 12.4 millones
